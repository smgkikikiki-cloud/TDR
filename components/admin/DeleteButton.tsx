"use client";
import { deleteBrand, deletePlant, deleteCompany, deleteEvent, deleteProductionProgram } from "@/app/admin/actions";

const actions={brand:deleteBrand,plant:deletePlant,company:deleteCompany,event:deleteEvent,production:deleteProductionProgram};
