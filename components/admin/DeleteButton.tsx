"use client";
import { deletePlant, deleteCompany, deleteEvent, deleteProductionProgram, deleteResearchArticle } from "@/app/admin/actions";

const actions={plant:deletePlant,company:deleteCompany,event:deleteEvent,production:deleteProductionProgram,research:deleteResearchArticle};
