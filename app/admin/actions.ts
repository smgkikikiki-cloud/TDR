...
export async function saveBrand() {
  await requireAdmin();
  throw new Error("Brand identity is canonical. Edit automotive/vehicle_master and publish one release.");
}
...
export async function saveModel() {
  await requireAdmin();
  throw new Error("Vehicle facts are canonical. Edit automotive/vehicle_master and publish one release.");
}
