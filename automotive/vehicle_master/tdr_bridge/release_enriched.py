...
def enrich_release(release: dict, *, data_dir: Path | str = DATA_DIR) -> dict:
    out = dict(release)
    out["historical_model_state"] = build_historical_model_state(data_dir=data_dir)
...
def main(argv=None) -> int:
    ...
    release = enrich_release(release, data_dir=args.data_dir)
