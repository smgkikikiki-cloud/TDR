# TDR internal automotive engine

This directory is the canonical vehicle-data subsystem inside TDR. It is not a
separate product or repository destination. All new automation, price harvests
and release commands run from the TDR repository.
